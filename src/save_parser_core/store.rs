...
impl Level {
    ...
    pub fn parsed_objects(&self) -> &[Object] {
        self.objects
            .as_deref()
            .expect("object model absent (lean or dropped store)")
    }
}
