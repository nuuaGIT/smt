...
pub(crate) const LIGHTWEIGHT_SUBSYSTEM: &str =
    ...
    match header {
        Header::Actor(ah) => {
            ...
            if tables.conveyor_belts.iter().any(|b| b == tp) {
                ...
                actor_specific = ActorSpecific::ConveyorBelt {
                    items,
                    count_field_off,
                    end_off: c.pos,
                };
                ...
                for idx in 0..num_belts {
                    ...
                    let mut elements =
                        Vec::with_capacity(c.capped_capacity(num_elements as usize, 4));
                    ...
                    belts.push(ChainBelt {
                        ...
                        b,
                        c: c3,
                        lead_item_index: lead,
                        tail_item_index: tail,
                    });
                }
                let cu32 = c.u32()?;
